 ...
 * @author Gercray
 */
public class Guia21_2 extends javax.swing.JFrame {

    /**
     * Creates new form Guia21_2
     */
    public Guia21_2() {
        initComponents();
        CreacionVentana();
    ...
    public void CreacionVentana(){
        this.setTitle("Programa de Operaciones");
        this.setSize(500,300);
        this.setLocation(100,100);
        
        etiNum1 = new JLabel();
        etiNum1.setText("Numeró 1:");
        etiNum1.setBounds(10,10,100,20);
        this.getContentPane().add(etiNum1);
        
        etiNum2 = new JLabel();
        etiNum2.setText("Numeró 1:");
        etiNum2.setBounds(10,10,100,20);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Guia21_2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
